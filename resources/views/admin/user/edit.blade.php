                ...
                <div class="col-md-7">
                    <form method="POST" action="{{ route('user.update', ['id' => $user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') in-valid @enderror" value="{{ $user->name }}" name="name" placeholder="Nhập username">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input class="form-control @error('email') in-valid @enderror" value="{{ $user->email }}" name="email" placeholder="Nhập email">
