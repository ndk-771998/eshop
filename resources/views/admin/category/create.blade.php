...
<div class="content-wrapper">
    ...
    @include('partials.content-header', ['title' => 'Danh mục sản phẩm', 'key' => 'Thêm mới'])
    <!-- /.content-header -->
            ...
            <div class="row">
                ...
                <form method="POST" action="{{route('categories.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="category_name" placeholder="Nhập tên danh mục">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="category_desc" id="" cols="30" rows="5"></textarea>
