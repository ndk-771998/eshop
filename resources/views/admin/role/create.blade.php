                ...
                <div class="col-md-7">
                    <form method="POST" action="{{ route('role.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') in-valid @enderror" value="{{ old('name') }}" name="name" placeholder="Nhập name">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input class="form-control @error('email') in-valid @enderror" value="{{ old('display_name') }}" name="display_name" placeholder="Nhập display name">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <input type="checkbox" class="checkbox_childrent" value="{{ $perChild->id }}" name="permission_id[]">
